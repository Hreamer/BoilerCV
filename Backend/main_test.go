...
func TestTemplate1(t *testing.T) {
	...
	tmplInfo := Template1Info{
		...
		Comp1Description1: "Fixed things",
		Comp1Description2: "Talked to folks",
		Comp1Description3: "Had a good time :)",

		CompName2:         "Libety Mutual",
		CompCity2:         "",
		CompState2:        "",
		CompTitle2:        "",
		CompLength2:       "",
		Comp2Description1: "Didn't do anything",
		Comp2Description2: "",
		Comp2Description3: "",
